...
private:
    ...
    // Method to read the user's choice for currency exchange menu option
    ...
    // Method to perform the selected currency exchange menu option
...
public:
    ...
    // Method to display the currency exchange menu
